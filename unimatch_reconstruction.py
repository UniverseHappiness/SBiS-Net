...
# [0.88814478 0.80971236 1.5484728  0.42476224]
# [0.89821622 0.82447248 1.3569049  0.36197534]
# [0.87552932 0.78474314 2.2447647  0.58024073]
# [0.89255748 0.81087067 2.15041554 0.67773629]
def main():
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, ((img_x, mask_x),
            ...
            # loss_recon = 0
            loss = (loss_x + loss_u_s1 * 0.25 + loss_u_s2 * 0.25 + loss_u_w_fp * 0.5 + loss_recon * 0.25) / 2.25

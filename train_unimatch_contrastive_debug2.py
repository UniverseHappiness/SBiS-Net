...
def main():
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, ((img_x, mask_x),
            ...
            loss_elastic_0 = elastic_contrastive_loss(low_feature_u_s1[0], high_feature_u_s2[0])
            ...
            loss = (loss_x + loss_u_s1 * 0.25 + loss_u_s2 * 0.25 + loss_u_w_fp * 0.5 + loss_elastic_0*0.25 + loss_elastic_1*0.25 + loss_elastic_2*0.25 + loss_elastic_3*0.25 ) / 3
